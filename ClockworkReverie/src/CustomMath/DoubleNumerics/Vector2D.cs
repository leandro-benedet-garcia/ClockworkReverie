...
/// <summary>Represents a vector with two single-precision doubleing-point values.</summary>
...
public partial struct Vector2D : IEquatable<Vector2D>, IFormattable
{
    ...
    public Vector2D(ReadOnlySpan<double> values)
    {
        if (values.Length != 2)
        {
            throw new InvalidLengthException("Input object must have two items");
        }
    ...
    /// <remarks>The <see cref="op_Division(ClockworkReverie.CustomMath.DoubleNumerics.Vector2D,double)" /> method defines the division operation for <see cref="Vector2D" /> objects.</remarks>
    ...
    public readonly void CopyTo(double[] array)
    {
        ...
        {
            throw new InvalidLengthException("Array must be at least of Length 2");
        }
    ...
    public readonly void CopyTo(double[] array, int index)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(index), index, "Index is too large");
        }
    ...
    public readonly void CopyTo(Span<double> destination)
    {
        ...
        {
            throw new InvalidLengthException("Span must be at least of Length 2");
        }
    ...
    public readonly bool Equals(Vector2D other)
    {
        ...
        static bool SoftwareFallback(in Vector2D self, Vector2D other)
        {
